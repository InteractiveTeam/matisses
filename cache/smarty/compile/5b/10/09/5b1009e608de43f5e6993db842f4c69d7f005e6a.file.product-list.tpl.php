<?php /* Smarty version Smarty-3.1.19, created on 2015-10-18 20:03:55
         compiled from "/var/www/www.matisses.co/www/themes/matisses/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6203308365624417b380af3-90554292%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b1009e608de43f5e6993db842f4c69d7f005e6a' => 
    array (
      0 => '/var/www/www.matisses.co/www/themes/matisses/product-list.tpl',
      1 => 1445107938,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6203308365624417b380af3-90554292',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5624417b70d066_61833159',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5624417b70d066_61833159')) {function content_5624417b70d066_61833159($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/www.matisses.co/www/tools/smarty/plugins/function.math.php';
?>
...
"<?php }?> class="<?php if ($_smarty_tpl->tpl_vars['page_name']->value!='index') {?>category_list <?php }?> product_list grid row<?php if (isset($_smarty_tpl->tpl_vars['class']->value)&&$_smarty_tpl->tpl_vars['class']->value) {?> <?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php }?>">
...
">
							...
							<?php if ($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction_type']=='percentage') {?>
											<span class="tag price-percent-reduction">-<?php echo $_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction']*100;?>
%</span>
							<?php }?>
							</div>
						<?php }?>
...
" itemprop="url" >
						...
						<p class="product-desc" itemprop="description">
							<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['product']->value['description_short']),300,'...');?>
...
" />
				...
				<div class="wrap_view wrap_visible_hover">
							<a itemprop="url" class="scale_hover_in lnk_view" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
">
							...
							<?php if (isset($_smarty_tpl->tpl_vars['quick_view']->value)&&$_smarty_tpl->tpl_vars['quick_view']->value) {?>
								<a class="scale_hover_in quick-view" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
							...
							<?php if (($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']==0||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&$_smarty_tpl->tpl_vars['product']->value['minimal_quantity']<=1&&$_smarty_tpl->tpl_vars['product']->value['customizable']!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
								<?php if ((!isset($_smarty_tpl->tpl_vars['product']->value['customization_required'])||!$_smarty_tpl->tpl_vars['product']->value['customization_required'])&&($_smarty_tpl->tpl_vars['product']->value['allow_oosp']||$_smarty_tpl->tpl_vars['product']->value['quantity']>0)) {?>
									<?php if (isset($_smarty_tpl->tpl_vars['static_token']->value)) {?>
										<a class=" btn btn_border ajax_add_to_cart_button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
">
									...
									<?php } else { ?>
										<a class=" btn btn_border ajax_add_to_cart_button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',false,null,'add=1&amp;id_product={$product.id_product|intval}',false), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow" title="<?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
" data-id-product="<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
">
											<span><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
						...
						<div class="share_product">
							<a data-target="https://plus.google.com/share?url=[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
]" class="btn_google" target="_blank"><i class="fa fa-google-plus"></i></a>
							<a data-target="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
&amp;title=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
&amp;source=<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
" class="btn_in" target="_blank"> <i class="fa fa-linkedin" ></i></a>
							<a data-target="http://twitter.com/home?status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 + <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
" class="btn_twitter" target="_blank"><i class="fa fa-twitter"></i></a>
							<a data-target="http://www.facebook.com/sharer.php?u=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
&amp;t=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
