<?php /* Smarty version Smarty-3.1.19, created on 2015-10-18 17:54:21
         compiled from "/var/www/www.matisses.co/www/themes/matisses/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20380543095624231d8ae127-14689720%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a00b495ec4df18e7db53c74dcc42a7c9ac7b2c34' => 
    array (
      0 => '/var/www/www.matisses.co/www/themes/matisses/product.tpl',
      1 => 1445107937,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20380543095624231d8ae127-14689720',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5624231e6f7691_70593538',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5624231e6f7691_70593538')) {function content_5624231e6f7691_70593538($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/www.matisses.co/www/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/www.matisses.co/www/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/var/www/www.matisses.co/www/tools/smarty/plugins/function.counter.php';
?>
...
"/>
				...
				<div class="wrap_condition_prod">
					...
					<?php }?>
					<span id="reduction_percent" class="tag price-percent-reduction" <?php if (!$_smarty_tpl->tpl_vars['product']->value->specificPrice||$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']!='percentage') {?> style="display:none;"<?php }?>>
...
%<?php }?>
					...
					<span id="reduction_amount" class="tag price-percent-reduction" <?php if (!$_smarty_tpl->tpl_vars['product']->value->specificPrice||$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']!='amount'||floatval($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])==0) {?> style="display:none"<?php }?>>
		...
		<div class="pb-right-column col-xs-12 col-md-5">
			...
			<?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?>
				<a class="print_prod" href="javascript:print();">
					<i class="fa fa-file-o"></i><?php echo smartyTranslate(array('s'=>'Print'),$_smarty_tpl);?>

				</a>
			<?php }?>
			<ul class="wrap_attr">
			<?php if (isset($_smarty_tpl->tpl_vars['product']->value->manufacturer_name)) {?>
			<li class="man_name"><label><?php echo smartyTranslate(array('s'=>'Brand:'),$_smarty_tpl);?>
 </label> 
				<span>
...
<?php }?></span>
			...
			<li id="availability_date"<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value||!isset($_smarty_tpl->tpl_vars['product']->value->available_date)||$_smarty_tpl->tpl_vars['product']->value->available_date<smarty_modifier_date_format(time(),'%Y-%m-%d')) {?> style="display: none;"<?php }?>>
			...
			<?php if (($_smarty_tpl->tpl_vars['display_qties']->value==1&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value&&$_smarty_tpl->tpl_vars['product']->value->available_for_order)) {?>
				...
				<li id="pQuantityAvailable"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0) {?> style="display: none;"<?php }?>>
...
&nbsp;</label>
											...
											<div class="attribute_list">
												<?php if (($_smarty_tpl->tpl_vars['group']->value['group_type']=='select')) {?>
													<select data-placeholder="{ l s ='Выберите страну'}" name="<?php echo $_smarty_tpl->tpl_vars['groupName']->value;?>
						...
						<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
							...
							<div class="price">
								<p class="our_price_display price product-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									<span id="old_price"<?php if ((!$_smarty_tpl->tpl_vars['product']->value->specificPrice||!$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])&&$_smarty_tpl->tpl_vars['group_reduction']->value==0) {?> class="hidden"<?php }?>>
...
<?php }?><?php }?> -->
									...
									<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?>
										<span id="our_price_display" <?php if ((!$_smarty_tpl->tpl_vars['product']->value->specificPrice||!$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])&&$_smarty_tpl->tpl_vars['group_reduction']->value==0) {?>class="no-reduce"<?php }?> itemprop="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['productPrice']->value),$_smarty_tpl);?>
</span>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for ecotax'),$_smarty_tpl);?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true);?>
					...
					<div class="wrap_quan">
						<label class=""><?php echo smartyTranslate(array('s'=>'QTY'),$_smarty_tpl);?>
</label>
						<!-- quantity wanted -->
...
<?php }?>
		...
		<div class="pb-center-column col-xs-12 col-md-3 ">
			<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayCustomBanners3'),$_smarty_tpl);?>

		</div>
		<!-- end center infos-->
	</div> <!-- end primary_block -->
	<?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?>
		   <?php if ($_smarty_tpl->tpl_vars['product']->value->description||$_smarty_tpl->tpl_vars['features']->value||$_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB']->value||$_smarty_tpl->tpl_vars['attachments']->value) {?>
			<!-- <div class="row"> -->
			<div id="more_info_block" class="clear">
				<ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
					<?php if ($_smarty_tpl->tpl_vars['product']->value->description) {?><li><a id="more_info_tab_more_info" class="selected" href="#idTab1"><?php echo smartyTranslate(array('s'=>'Description'),$_smarty_tpl);?>
</a></li><?php }?>
					...
					<?php if ($_smarty_tpl->tpl_vars['attachments']->value) {?><li><a id="more_info_tab_attachments" href="#idTab3"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</a></li><?php }?>
					...
					<li><a href="#idTab6"><?php echo smartyTranslate(array('s'=>'Discounts'),$_smarty_tpl);?>
</a></li>
					<?php }?>
				...
				<div id="more_info_sheets" class="sheets align_justify">
					<?php if ($_smarty_tpl->tpl_vars['product']->value->description) {?>
						<!-- full description -->
						<div id="idTab1"><?php echo $_smarty_tpl->tpl_vars['product']->value->description;?>
</div>
					<?php }?>
...
?>
								<li class="row"><div class="clearfix"><span class="name_bullet col-md-4 col-xs-6"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</span> <span class="value_bullet col-md-8 col-xs-6"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['value'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</span></div></li>
							<?php } ?>
						</ul>
					<?php }?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)) {?>
							<div class="wrap_features">
								<?php if (isset($_smarty_tpl->tpl_vars['accessory']->value['new'])&&$_smarty_tpl->tpl_vars['accessory']->value['new']==1) {?>
									<a class="new tag" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
">
							...
							<?php if (isset($_smarty_tpl->tpl_vars['accessory']->value['on_sale'])&&$_smarty_tpl->tpl_vars['accessory']->value['on_sale']&&isset($_smarty_tpl->tpl_vars['accessory']->value['show_price'])&&$_smarty_tpl->tpl_vars['accessory']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
								<a class="tag sale" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
">
							...
							<?php if ($_smarty_tpl->tpl_vars['accessory']->value['specific_prices']['reduction_type']=='percentage') {?>
											<span class="tag price-percent-reduction">-<?php echo $_smarty_tpl->tpl_vars['accessory']->value['specific_prices']['reduction']*100;?>
%</span>
							<?php }?>
							</div>
						<?php }?>
							...
							<?php if (isset($_smarty_tpl->tpl_vars['accessory']->value['available_for_order'])&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
								<span itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="availability scale_hover_in hidden-list">
									...
									<?php } elseif ((isset($_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions'])&&$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0)) {?>
										<span class="tag out">
											<link itemprop="availability" href="http://schema.org/LimitedAvailability" /><?php echo smartyTranslate(array('s'=>'Available different options'),$_smarty_tpl);?>
...
" itemprop="url" >
						...
						<p class="product-desc" itemprop="description">
							<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['accessory']->value['description_short']),300,'...');?>
...
" />
					...
					<?php if (isset($_smarty_tpl->tpl_vars['accessory']->value['color_list'])) {?>
				...
				<div class="wrap_view wrap_visible_hover">
							<a itemprop="url" class="scale_hover_in lnk_view" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
">
							...
							<?php if (isset($_smarty_tpl->tpl_vars['quick_view']->value)&&$_smarty_tpl->tpl_vars['quick_view']->value) {?>
								<a class="scale_hover_in quick-view" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
" rel="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
">
									<i class="font-eye"></i><span><?php echo smartyTranslate(array('s'=>'Quick view'),$_smarty_tpl);?>
</span>
								</a>
							<?php }?>
							...
							<?php if (($_smarty_tpl->tpl_vars['accessory']->value['id_product_attribute']==0||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&$_smarty_tpl->tpl_vars['accessory']->value['minimal_quantity']<=1&&$_smarty_tpl->tpl_vars['accessory']->value['customizable']!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
								<?php if ((!isset($_smarty_tpl->tpl_vars['accessory']->value['customization_required'])||!$_smarty_tpl->tpl_vars['accessory']->value['customization_required'])&&($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)) {?>
									<?php if (isset($_smarty_tpl->tpl_vars['static_token']->value)) {?>
										<a class=" btn btn_border ajax_add_to_cart_button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
...
">
									...
									<?php } else { ?>
										<a class=" btn btn_border ajax_add_to_cart_button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',false,null,'add=1&amp;id_product={$accessory.id_product|intval}',false), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow" title="<?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
" data-id-product="<?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
">
											<span><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
