...
class BlockSearch extends Module
{
	...
	{
		if (!parent::install() || !$this->registerHook('top') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap') || !$this->registerHook('displayMatBuscador'))
			return false;
		return true;
	}
...
*/
	...
	public function hookdisplayMatBuscador($params)
	{
		return $this->hookTop($params);
	}
