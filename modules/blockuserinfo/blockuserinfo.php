...
class BlockUserInfo extends Module
{
	...
	{
		return (parent::install() && $this->registerHook('displayTop') && $this->registerHook('displayNav') && $this->registerHook('displayHeader') && $this->registerHook('displayMatUser'));
	}

	public function hookdisplayMatUser($params)
	{
