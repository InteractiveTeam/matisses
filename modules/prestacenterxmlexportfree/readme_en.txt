...
* In the administration of module click on "Add a new module" and select the file
  prestacenterxmlexportfreeXXXX.zip from your computer.
* If you are installing the module for the first time, select from the
  "Other modules" module "PrestaCenter XML Export Free" and click on "Install".
...
* The module PrestaCenter XML Export Free is the last item of the menu "Catalog"
  (main BO menu).
