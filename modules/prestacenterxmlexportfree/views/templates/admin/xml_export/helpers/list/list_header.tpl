			...
			<tr>
				<td style="vertical-align: bottom;">
					<span style="float: left;">
						...
						{/if}
						{l s='Page' mod='prestacenterxmlexportfree'} <b>{$page|escape}</b> / {$total_pages|escape}
						{if $page < $total_pages}
						...
						/ {$list_total|escape} {l s='result(s)' mod='prestacenterxmlexportfree'}
					</span>
					<span style="float: right;">
						<input type="submit" name="submitReset{$table|strval}" value="{l s='Reset' mod='prestacenterxmlexportfree'}" class="button" />
						<input type="submit" id="submitFilterButton{$table|strval}" name="submitFilter" value="{l s='Filter' mod='prestacenterxmlexportfree'}" class="button" />
					</span>
