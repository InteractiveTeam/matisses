...
<b>{literal}{update_feed}{/literal}</b> - {l s='Date and time when the file was created (GMT). You can use custom format.' mod='prestacenterxmlexportfree'}<br />
<b>{literal}{update_item_local}, {update_feed_local}{/literal}</b> - {l s='Local date and time of creating the feed or last update of the product. You can use custom format.' mod='prestacenterxmlexportfree'}<br />*}
<b>{literal}{date_feed}{/literal}</b> - {l s='Date and time when the feed was created.' mod='prestacenterxmlexportfree'} <br />
<b>{literal}{date_add}{/literal}</b> - {l s='Date and time when the product was added in shop.' mod='prestacenterxmlexportfree'} <br />
<b>{literal}{date_upd}{/literal}</b> - {l s='Date and time when the product was updated in shop.' mod='prestacenterxmlexportfree'}<br />
{l s='All date and time variables use as default Atom 1.0 format (e.g. "2012-12-08T14:29:57+00:00"). It is possible to use custom format - see PHP date() function. Two modifiers are available - LOCAL (default) for local time and GMT for Greenwich Mean Time. Samples:' mod='prestacenterxmlexportfree'} <b>{literal}{date_feed: GMT}, {date_add: "Y-m-d H:i:s": LOCAL}, {date_upd: "d.m.Y H:i:s"}{/literal}</b><br />
...
{l s='Customization options: enter your own values in this order - "in stock", "to order" and "sold out". They should not start with a number sign, which is reserved for special values. You can enter spaces after commas for improve readability.' mod='prestacenterxmlexportfree'}
<br />
...
$('a.prestacenterxmlexportfreetoggle').each(function() {
	$(this).click(function(button) {
		var texty = {
			...
			4: "{l s='Show help to product features' mod='prestacenterxmlexportfree'}",
		};
