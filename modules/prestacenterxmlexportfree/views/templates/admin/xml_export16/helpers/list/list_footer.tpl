...
<div class="row">
	<div class="col-lg-8">
		...
		<div class="btn-group bulk-actions">
			<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
				{l s='Bulk actions' mod='prestacenterxmlexportfree'} <span class="caret"></span>
			</button>
			...
			<li>
				<a href="#" onclick="if (!$('table.table').first().find(':checkbox[name=checkme]').first().prop('checked')) { $('table.table').first().find(':checkbox[name=checkme]').first().click() }; return false;">
					<i class="icon-check-sign"></i>&nbsp;{l s='Select all' mod='prestacenterxmlexportfree'}
				</a>
			</li>
			<li>
				<a href="#" onclick="if ($('table.table').first().find(':checkbox[name=checkme]').first().prop('checked')) { $('table.table').first().find(':checkbox[name=checkme]').first().click() }; return false;">
					<i class="icon-check-empty"></i>&nbsp;{l s='Unselect all' mod='prestacenterxmlexportfree'}
				</a>
			</li>
			<li class="divider"></li>
	...
	<div class="col-lg-4">
		...
		<span class="pagination">
			...
			/ {$list_total|strval} {l s='result(s)' mod='prestacenterxmlexportfree'}
