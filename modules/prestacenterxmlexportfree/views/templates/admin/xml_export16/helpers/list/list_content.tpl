				...
				*}
				...
				{if isset($tr.$key)}
					...
					{elseif isset($params.activeVisu)}
						{if $tr.$key}
							<i class="icon-check-ok"></i> {l s='Enabled' mod='prestacenterxmlexportfree'}
						{else}
							<i class="icon-remove"></i> {l s='Disabled' mod='prestacenterxmlexportfree'}
						{/if}
					...
					{elseif isset($params.type) && $params.type == 'percent'}
						{$tr.$key|strval} {l s='%' mod='prestacenterxmlexportfree'}
	...
	<tr>
		<td class="list-empty" colspan="{count($fields_display) + 2|escape:'intval'}">
			<div class="list-empty-msg">
				...
				{l s='No items found' mod='prestacenterxmlexportfree'}
			</div>
		</td>
	</tr>
{/if}
