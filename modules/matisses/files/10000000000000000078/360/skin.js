...
// Generated vie nov 28 11:07:30 2014
...
function object2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._left__img.setAttribute('src',basePath + 'cnt/left.svg');
		this._left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._left__img['ondragstart']=function() { return false; };
		this._left.appendChild(this._left__img);
		this._left.onmouseover=function () {
			me._left__img.src=basePath + 'cnt/left__o.svg';
		}
		this._left.onmouseout=function () {
			me._left__img.src=basePath + 'cnt/left.svg';
		...
		this._right__img.setAttribute('src',basePath + 'cnt/right.svg');
		this._right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._right__img['ondragstart']=function() { return false; };
		this._right.appendChild(this._right__img);
		this._right.onmouseover=function () {
			me._right__img.src=basePath + 'cnt/right__o.svg';
		}
		this._right.onmouseout=function () {
			me._right__img.src=basePath + 'cnt/right.svg';
		...
		this._zoomin__img.setAttribute('src',basePath + 'cnt/zoomin.svg');
		...
		this._zoomin.onmouseover=function () {
			...
			me._zoomin__img.src=basePath + 'cnt/zoomin__o.svg';
		}
		this._zoomin.onmouseout=function () {
			me._tt_zoomin.style[domTransition]='none';
			me._tt_zoomin.style.visibility='hidden';
			me._tt_zoomin.ggVisible=false;
			me._zoomin__img.src=basePath + 'cnt/zoomin.svg';
		...
		this._zoomout__img.setAttribute('src',basePath + 'cnt/zoomout.svg');
		...
		this._zoomout.onmouseover=function () {
			...
			me._zoomout__img.src=basePath + 'cnt/zoomout__o.svg';
		}
		this._zoomout.onmouseout=function () {
			me._tt_zoomout.style[domTransition]='none';
			me._tt_zoomout.style.visibility='hidden';
			me._tt_zoomout.ggVisible=false;
			me._zoomout__img.src=basePath + 'cnt/zoomout.svg';
		...
		this._autorotate__img.setAttribute('src',basePath + 'cnt/autorotate.svg');
		...
		this._autorotate.onmouseover=function () {
			...
			me._autorotate__img.src=basePath + 'cnt/autorotate__o.svg';
		}
		this._autorotate.onmouseout=function () {
			me._tt_autorotate.style[domTransition]='none';
			me._tt_autorotate.style.visibility='hidden';
			me._tt_autorotate.ggVisible=false;
			me._autorotate__img.src=basePath + 'cnt/autorotate.svg';
		}
		...
		this._fullscreen__img.setAttribute('src',basePath + 'cnt/fullscreen.svg');
		...
		this._fullscreen.onmouseover=function () {
			...
			me._fullscreen__img.src=basePath + 'cnt/fullscreen__o.svg';
		}
		this._fullscreen.onmouseout=function () {
			me._tt_fullscreen.style[domTransition]='none';
			me._tt_fullscreen.style.visibility='hidden';
			me._tt_fullscreen.ggVisible=false;
			me._fullscreen__img.src=basePath + 'cnt/fullscreen.svg';
		}
		...
		this._marker_active__img.setAttribute('src',basePath + 'cnt/marker_active.svg');
		...
		this._marker_normal__img.setAttribute('src',basePath + 'cnt/marker_normal.svg');
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._hsimage__img.setAttribute('src',basePath + 'cnt/hsimage.svg');
