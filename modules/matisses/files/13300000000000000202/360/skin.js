...
// Object2VR 3.0/10616
// Filename: 360matisses.ggsk
// Generated mar sep 23 10:39:55 2014
...
function object2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._left__img.setAttribute('src',basePath + 'control/left.svg');
		this._left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._left__img['ondragstart']=function() { return false; };
		this._left.appendChild(this._left__img);
		this._left.onmouseover=function () {
			me._left__img.src=basePath + 'control/left__o.svg';
		}
		this._left.onmouseout=function () {
			me._left__img.src=basePath + 'control/left.svg';
		...
		this._right__img.setAttribute('src',basePath + 'control/right.svg');
		this._right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._right__img['ondragstart']=function() { return false; };
		this._right.appendChild(this._right__img);
		this._right.onmouseover=function () {
			me._right__img.src=basePath + 'control/right__o.svg';
		}
		this._right.onmouseout=function () {
			me._right__img.src=basePath + 'control/right.svg';
		...
		this._zoomin__img.setAttribute('src',basePath + 'control/zoomin.svg');
		...
		this._zoomin.onmouseover=function () {
			...
			me._zoomin__img.src=basePath + 'control/zoomin__o.svg';
		}
		this._zoomin.onmouseout=function () {
			me._tt_zoomin.style[domTransition]='none';
			me._tt_zoomin.style.visibility='hidden';
			me._tt_zoomin.ggVisible=false;
			me._zoomin__img.src=basePath + 'control/zoomin.svg';
		...
		this._zoomout__img.setAttribute('src',basePath + 'control/zoomout.svg');
		...
		this._zoomout.onmouseover=function () {
			...
			me._zoomout__img.src=basePath + 'control/zoomout__o.svg';
		}
		this._zoomout.onmouseout=function () {
			me._tt_zoomout.style[domTransition]='none';
			me._tt_zoomout.style.visibility='hidden';
			me._tt_zoomout.ggVisible=false;
			me._zoomout__img.src=basePath + 'control/zoomout.svg';
		...
		this._autorotate__img.setAttribute('src',basePath + 'control/autorotate.svg');
		...
		this._autorotate.onmouseover=function () {
			...
			me._autorotate__img.src=basePath + 'control/autorotate__o.svg';
		}
		this._autorotate.onmouseout=function () {
			me._tt_autorotate.style[domTransition]='none';
			me._tt_autorotate.style.visibility='hidden';
			me._tt_autorotate.ggVisible=false;
			me._autorotate__img.src=basePath + 'control/autorotate.svg';
		}
		...
		this._tt_autorotate__text.innerHTML="Rotar";
		...
		this._fullscreen__img.setAttribute('src',basePath + 'control/fullscreen.svg');
		...
		this._fullscreen.onmouseover=function () {
			...
			me._fullscreen__img.src=basePath + 'control/fullscreen__o.svg';
		}
		this._fullscreen.onmouseout=function () {
			me._tt_fullscreen.style[domTransition]='none';
			me._tt_fullscreen.style.visibility='hidden';
			me._tt_fullscreen.ggVisible=false;
			me._fullscreen__img.src=basePath + 'control/fullscreen.svg';
		}
		...
		this._tt_fullscreen__text.innerHTML="Pantalla Completa";
		...
		this._marker_active__img.setAttribute('src',basePath + 'control/marker_active.svg');
		...
		this._marker_normal__img.setAttribute('src',basePath + 'control/marker_normal.svg');
	...
	this.skinTimerEvent=function() {
		...
		if (me.elementMouseDown['left']) {
			me.player.changePanLog(0.09,true);
		}
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._hsimage__img.setAttribute('src',basePath + 'control/hsimage.svg');
