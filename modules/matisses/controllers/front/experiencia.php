...
class matissesexperienciaModuleFrontController extends ModuleFrontController {
    ...
    public function initContent() {
        ...
        $path[] = '<span class="navigation"><a href="/experiencias">Experiencias 2</a></span>';
		...
		$this->setTemplate('experiencia.tpl');
	}
