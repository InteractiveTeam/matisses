...
class Blocknewsletter extends Module
{
	...
	{
		if (!parent::install() || !$this->registerHook(array('header', 'footer', 'actionCustomerAccountAdd','displayMatNewsletter')))
			return false;
	...
	public function hookdisplayMatNewsletter($params)
	{
	...
	protected function newsletterRegistration()
	{
		...
		if ($_POST['habeas']!=1)
			return $this->error = $this->l('Debe aceptar terminos y condiciones');	
