...
<h1>{l s='Resultado de búsqueda'}</h1>
<p>{l s='Estas son las listas que coinciden con  tu búsqueda. Si no ves la que estás buscando, verifica la información que ingresaste.' mod='giftlist'}</p>
