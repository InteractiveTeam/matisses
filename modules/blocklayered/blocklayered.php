...
class BlockLayered extends Module
{
	...
	public function hookHeader($params)
	{
		...
		$this->context->controller->addJS(($this->_path).'js/jquery.mCustomScrollbar.min.js');
		...
		$this->context->controller->addCSS(($this->_path).'css/jquery.mCustomScrollbar.css', 'all');
