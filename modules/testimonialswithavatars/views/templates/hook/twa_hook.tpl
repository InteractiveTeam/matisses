...
<div class="twa_container{if $in_column} block{/if}">
	...
	<a class="view_all neat" href="{$link->getModuleLink('testimonialswithavatars', 'testimonials')|escape:'html'}" title="{l s='View all' mod='testimonialswithavatars'}">
