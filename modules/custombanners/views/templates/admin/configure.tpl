...
<div class="custombanners all-banners panel">
	...
	<div id="{$hk|escape:'html'}" class="hook-contents {if $hk == 'displayHome'}active{/if}">
		...
		<div class="alert alert-info">
			{l s='In order to display this hook, insert the following code to any tpl' mod='custombanners'}: <strong>{literal}{hook h='{/literal}{$hk|escape:'html'}{literal}'}{/literal}</strong>
		</div>
		{/if}
				...
				<div class="col-md-1">
					<div class="multiclass">
						...
						<div class="list" style="display:none;">
							...
							<ul>
							{for $col=1 to 12}
								<li class="" data-class="col-{$class|escape:'html'}-{$col|intval}">
									<span class="cl"><span class="fragment">col-{$class|escape:'html'}-</span>{$col|intval}</span>
									<span class="grey-note">{($col*100/12)|round:2}%</span>
								</li>
							{/for}
							</ul>
						</div>
