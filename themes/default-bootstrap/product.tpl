...
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block grid_12 alpha omega">
		...
		<!-- end left infos-->
		<!-- center infos -->
		<div class="pb-center-column grid_6 omega">
		...
		<!-- end center infos-->
		<!-- pb-right-column-->
		<div class="pb-right-column grid_6">
				...
				<div class="box-info-product">
					...
					<div class="product_attributes cf">
						...
						<p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
							...
							<a href="javascript:void(0)" data-field-qty="qty" class="btn btn-default button-minus product_quantity_down">
								<span><i class="icon-minus"></i></span>
							</a>
							<a href="javascript:void(0)" data-field-qty="qty" class="btn btn-default button-plus product_quantity_up">
