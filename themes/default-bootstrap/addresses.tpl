...
*}
{capture name=path}<a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">{l s='My account'}</a><i class="fa fa-angle-right"></i><span class="navigation_page">{l s='My addresses'}</span>{/capture}
