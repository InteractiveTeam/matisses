...
{if isset($products) && $products}
    ...
    {foreach from=$products item=product name=products}
        ...
        {assign var='status' value=matisses::changeAttrDefault($product.id_product,$product.id_product_attribute)}
        
        {if $status.status == 'ok'}
            {$product.cache_default_attribute = $status.id_prod_attr}
            {$product.id_product_attribute = $status.id_prod_attr}
