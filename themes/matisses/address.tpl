...
<div class="adress-add grid_12 alpha omega">
	...
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std add-address" id="add_address">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			...
			<div class="required form-group grid_6 dni">
			...
			{if $field_name eq 'postcode'}
				...
				<div class="required postcode form-group unvisible grid_6">
			...
			{if $field_name eq 'State:name'}
				...
				<div class="required id_state form-group grid_6">
			...
			{if $field_name eq 'phone_mobile'}
				...
				<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group grid_6">
		...
		{/if}
		{if !$stateExist}
			<div class="required id_state form-group unvisible grid_6">
				<label for="id_state">{l s='State'} <sup>*</sup></label>
		...
		{/if}
		{if !$dniExist}
			<div class="required dni form-group unvisible grid_6">
				<label for="dni">{l s='Identification number'} <sup>*</sup></label>
		...
		{/if}
		<div class="required form-group grid_6" id="adress_alias">
