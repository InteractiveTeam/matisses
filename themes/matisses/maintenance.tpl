...
{/if}
		...
		<link href="{$css_dir}modules/problocksocial/views/css/problocksocial.css" rel="stylesheet" type="text/css" />
		<link href="{$css_dir}modules/problocknewsletter/views/css/problocknewsletter.css" rel="stylesheet" type="text/css" />
		<script src="{$js_dir}maintenance/jquery-1.11.2.min.js?time"></script>
		<script src="{$js_dir}modules/problocknewsletter/views/js/problocknewsletter.js"></script>
			...
			<div id="maintenance" class="clearfix">
				<div class="container">
					 <div class="logo">
						...
						<span>{l s='Foxlore'}</span>
					 </div>
						<h1 class="maintenance-heading"><span>{l s='WE ARE'}</span> {l s='LAUNCHING SOON'}</h1>
						<div id="message">
