		...
		<ul>
        	<li class="clearfix item">
                ...
                {if isset($special.new) && $special.new == 1}
                                <a class="new tag " href="{$special.link|escape:'html':'UTF-8'}">
                                    <span class="new-label">{l s='New'}</span>
                                </a>
                            {/if}
                            {if isset($special.on_sale) && $special.on_sale && isset($special.show_price) && $special.show_price && !$PS_CATALOG_MODE}
                                <a class="tag sale" href="{$special.link|escape:'html':'UTF-8'}">
                                    <span class="sale-label">{l s='Sale!'}</span>
                                </a>
                {/if}
            </div>
                <div class="product-content">
                    <div class="rate_left_product">{hook h='displayProductListReviews' product=$special}</div>
                	<h5>
