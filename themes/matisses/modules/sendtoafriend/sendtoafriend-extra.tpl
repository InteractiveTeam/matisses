...
<li class="sendtofriend">
	<a id="send_friend_button" href="#send_friend_form">
		<span class="hidden-xxs">{l s='Send to a friend' mod='sendtoafriend'}</span>
	</a>
		...
		<div id="send_friend_form">
			...
			<div class="row">
				<div class="product clearfix col-xs-12">
					<img src="{$link->getImageLink($stf_product->link_rewrite, $stf_product_cover, 'small_default')|escape:'html':'UTF-8'}" alt="{$stf_product->name|escape:'html':'UTF-8'}" />
