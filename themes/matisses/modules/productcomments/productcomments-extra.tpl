		...
		{if $nbComments != 0}
			{*<li>
				<a href="#idTab5" class="reviews">
					<span class="hidden-xxs">{l s='Read reviews' mod='productcomments'}</span> (<span itemprop="reviewCount">{$nbComments}</span>)
				</a>
			</li>*}
		{/if}
		{if ($too_early == false AND ($is_logged OR $allow_guests))}
			<li>
				<a class="open-comment-form" href="#new_comment_form">
					<span class="hidden-xxs">{l s='Write a review' mod='productcomments'}</span>
				</a>
			</li>
		{/if}
	</ul>
