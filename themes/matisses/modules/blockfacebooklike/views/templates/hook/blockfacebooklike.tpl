...
<div class="footer-block facebook-box col-sm-3 col-xs-12">
	<h4 class="title_block dropdown-cntrl">{$FB_title|escape:'none'}</h4>
	<div class="dropdown-content toggle-footer">
		<div class="block_content">
			<div class="fb_info_top">
				{if $company_logo}
				<img src="https://graph.facebook.com/{$FB_data.id|escape:'none'}/picture" alt="{$FB_data.name}" class="fb_avatar" />
				{/if}
				<div class="fb_info">
					{if $company_name}
			...
			<a href="{$FB_page_URL}" target="_blank" class="likeButton"><span>{l s='Like' mod='blockfacebooklike'}</span></a>
