...
<div id="newsletter_block_left" class="col-md-8 col-sm-7 col-xs-12">
	<h4 class="text_upper hidden-xs hidden-sm">
		<span>{l s='Newsletter subscription' mod='problocknewsletter'}</span>
	</h4>
	<div class="block_content">
		<form action="{$link->getPageLink('index')|escape:'html':'UTF-8'}" method="post">
			<div class="form-group{if isset($msg) && $msg } {if $nw_error}form-error{else}form-ok{/if}{/if}" >
				<input class="inputNew form-control white newsletter-input" id="newsletter-input" type="text" name="email" size="18" value="{if isset($msg) && $msg}{$msg}{elseif isset($value) && $value}{$value}{else}{l s='Enter your e-mail' mod='problocknewsletter'}{/if}" />
