...
class ToolsCore
{
	...
	*/
	public static function getFullPath($id_category, $end, $type_cat = 'products', Context $context = null)
	{
		...
		return Tools::getPath($id_category, $category->name, true, $type_cat).'<i class="fa fa-angle-right"></i><span class="navigation_product">'.htmlentities($end, ENT_NOQUOTES, 'UTF-8').'</span>';
	}
